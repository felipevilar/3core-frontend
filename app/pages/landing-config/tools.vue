...
const { groups, status, updateGroup, deleteGroup, createGroup, updateItem, deleteItem, createItem } = useLandingConfig('tool')
    ...
    <div class="flex items-center justify-between mb-6">
      <div>
        ...
        <p class="text-sm text-muted mt-0.5">
          Equipamentos e ferramentas exibidos no formulário de cadastro de técnicos.
        </p>
      </div>
    </div>
